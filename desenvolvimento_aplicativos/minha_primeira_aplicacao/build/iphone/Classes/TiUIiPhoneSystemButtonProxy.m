...
MAKE_SYSTEM_PROP(ACTIVITY,UIminha_primeira_aplicacaoNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIminha_primeira_aplicacaoNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIminha_primeira_aplicacaoNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIminha_primeira_aplicacaoNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIminha_primeira_aplicacaoNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIminha_primeira_aplicacaoNativeItemContactAdd);
