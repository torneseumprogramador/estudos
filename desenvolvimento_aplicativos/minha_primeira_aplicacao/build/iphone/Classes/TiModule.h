...
/**
 The base class for all minha_primeira_aplicacao modules
 */
...
/**
 minha_primeira_aplicacao Platform calls this method on startup.
 */
-(void)startup;

/**
 minha_primeira_aplicacao Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 minha_primeira_aplicacao Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 minha_primeira_aplicacao Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 minha_primeira_aplicacao Platform calls this method on resume.
 @param sender The sender of the event.
 */
