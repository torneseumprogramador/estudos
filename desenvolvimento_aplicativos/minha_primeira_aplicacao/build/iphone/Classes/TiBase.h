...
// in simulator we redefine to format for minha_primeira_aplicacao Developer console
...
{\
	NSString * exceptionName = [@"org.minha_primeira_aplicacao." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.minha_primeira_aplicacao";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIminha_primeira_aplicacaoNativeItemNone = -1, 
	UIminha_primeira_aplicacaoNativeItemSpinner = -2,
	UIminha_primeira_aplicacaoNativeItemProgressBar = -3,
	
	UIminha_primeira_aplicacaoNativeItemSlider = -4,
	UIminha_primeira_aplicacaoNativeItemSwitch = -5,
	UIminha_primeira_aplicacaoNativeItemMultiButton = -6,
	UIminha_primeira_aplicacaoNativeItemSegmented = -7,
	
	UIminha_primeira_aplicacaoNativeItemTextView = -8,
	UIminha_primeira_aplicacaoNativeItemTextField = -9,
	UIminha_primeira_aplicacaoNativeItemSearchBar = -10,
	
	UIminha_primeira_aplicacaoNativeItemPicker = -11,
	UIminha_primeira_aplicacaoNativeItemDatePicker = -12,
	
	UIminha_primeira_aplicacaoNativeItemInfoLight = -13,
	UIminha_primeira_aplicacaoNativeItemInfoDark = -14,
	
	UIminha_primeira_aplicacaoNativeItemDisclosure = -15,
	
	UIminha_primeira_aplicacaoNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all minha_primeira_aplicacao instances of
