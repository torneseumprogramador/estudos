 ...
 * to send analytic data that can be viewed on the minha_primeira_aplicacao Dashboard.
 *
 * For information on getting started with minha_primeira_aplicacao Platform Services,
