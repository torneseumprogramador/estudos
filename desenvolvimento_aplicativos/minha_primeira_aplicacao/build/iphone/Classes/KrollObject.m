...
//@interface minha_primeira_aplicacaoObject : NSObject
//@end

@interface minha_primeira_aplicacaoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[minha_primeira_aplicacaoObject class]])
		{
			for (NSString *key in [[(minha_primeira_aplicacaoObject*)o modules] allKeys])
			{
