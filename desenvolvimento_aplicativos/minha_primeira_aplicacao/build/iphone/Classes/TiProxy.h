...
//Rare exceptions to indicate a bug in the _minha_primeira_aplicacao code (Eg, function that a subclass should have implemented)
...
/**
 The base class for minha_primeira_aplicacao proxies.
 */
