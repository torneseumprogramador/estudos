...
/**
 Base class for all minha_primeira_aplicacao views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the minha_primeira_aplicacao view hierarchy (such as wrapped iOS UIViews) was touched.
